...
| 15 | milestones | milestone-drag, milestone-label-side, milestone-swimlane-span | milestones.spec.ts | ✅ PR #15 |
| 16 | mobile | mobile-card-view, mobile-card-toggles, mobile-layout, initiative-panel-date-fields-mobile | mobile.spec.ts | 🔲 |
| 17 | reports | reports-mode, reports-home, capacity-report, maturity-heatmap, rag-status, report-history-diff, reports-versions-error | reports.spec.ts | 🔲 |
| 18 | segments | segment-delete-button, segment-vertical-drag-stability, segment-drag-improvements, segment-vertical-resize, segment-label-clamp, segment-application-selector, segment-conflict-resolution, segment-delete-confirm | segments.spec.ts | 🔲 |
| 19 | swimlanes | swimlane-grouping, swimlane-height-collapse, swimlane-padding | swimlanes.spec.ts | ✅ PR #15 |
| 20 | timeline | timeline-create, timeline-settings, timeline-start-date, timeline-weekly-columns-monday, snap-to-month, today-indicator, zoom-control, floating-legend, critical-path, view-options-popover | timeline.spec.ts | 🔲 |
| 21 | tutorial | tutorial-content, tutorial-modal | tutorial.spec.ts | 🔲 |
| 22 | undo-redo | undo-redo, undo-redo-edge-cases, undo-depth | undo-redo.spec.ts | 🔲 |
| 23 | version-history | version-history, version-snapshot-integrity | version-history.spec.ts | 🔲 |
| 24 | visualiser | visualiser, visualiser-only-controls | visualiser.spec.ts | 🔲 |
| 25 | workspace | workspace-templates, template-demo-toggle, large-dataset, cascading-deletes, security-headers, owner-assignee, progress-tracking, resources, labels, tap-to-select, table-sorting | workspace.spec.ts | 🔲 |
