...
## US-RP-08: Repair a Missing or Ambiguous RPTI Target
...
- A declared RPTI Target takes precedence over other timeline history; inference considers all years.
...
- Data Manager → Initiatives offers the RPTI Target selector, and repairing it allows the next generation to be exported.
