...
Programmes and assets don't yet have their own detail panel in Scenia, so decisions linked to them are visible from the Decisions list (each row shows what it's linked to) rather than from a dedicated panel.
