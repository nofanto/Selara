...
const slides = [
  {
    title: 'Welcome to Selara',
    text: 'Selara is a complete initiative planning tool. Map your work across time, track costs and sequencing, understand dependencies, and report on progress — all in one place, with no data leaving your browser.',
